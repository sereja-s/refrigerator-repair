...
class Order
{
...

	{
		...
		// преобразуем переменную: $products (в которой хранится массив) в строку в формате: json (что бы с ней можно было работать в БД)
		...
		// Текст запроса к БД (добавляем данные, которые были переданы для сохранения)
